...
//  SlotMachine
//
//  Created by bartosz on 11/06/2015.
...
class Factory {
    ...
    class func createSlots() -> [[Slot]] { // return array of arrays? yes
        ...
        for var contN = 0; contN < kNumberOfContainers; ++contN {
            var slotArray:[Slot] = []
            for var slotN = 0; slotN < kNumberOfSlots; ++slotN {
                var slot = createSlot(slotArray) // or simply createSlot(slotArray) - jakby funkcja statyczna?
